        ...
        <div className="bg-white rounded-lg border px-3">
          <ScrollArea>
            <TabsList className="p-0 bg-background justify-start rounded-none h-13">
              <TabsTrigger value="summary" className="triger-tabs">
                <BookOpenTextIcon />
                Summary
              </TabsTrigger>

              <TabsTrigger value="transcript" className="triger-tabs">
                <FileTextIcon />
                Transcript
              </TabsTrigger>

              <TabsTrigger value="recording" className="triger-tabs">
                <FileVideoIcon />
                Recording
              </TabsTrigger>

              <TabsTrigger value="chat" className="triger-tabs">
                <SparklesIcon />
                Ask AI
              </TabsTrigger>
            </TabsList>
